...
function createGrass() {
    var grass_geometry = new THREE.CircleGeometry(window.innerWidth > window.innerHeight ? window.innerWidth / 20 : -window.innerWidth / 20, 2000);
...
function createFlowers(){
    ...
    for(var i = 0; i < number_of_flowers; i++) {
        ...
        flower_mesh.position.x = (Math.random() -0.5) *  2 * window.innerWidth / 50;
        flower_mesh.position.y = 0;
        flower_mesh.position.z = (Math.random() - 0.5) * 2 * window.innerHeight / 50;
